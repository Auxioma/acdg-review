            ...
            <div class="container-fluid align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <form class="d-flex column-gap-2 align-items-center ms-auto order-lg-2" role="search">
                        ...
                        <a href="index.html"><i class="fa-solid fa-magnifying-glass"
                                style="width: 20px;height: 100%;"></i></a>
        ...
        <div class="offcanvas offcanvas-end " data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
            ...
            <div class="offcanvas-body">
                ...
                <div class="row mt-3 text-center">
                    <a href="account.html"><button class="btn" type="submit" id="bouton_orange"> Se connecter </button>
                    </a>
                </div>
                <div class="row my-1 text-center">
